[![Build status](https://ci.appveyor.com/api/projects/status/q5vw3wafh0sbbkfn/branch/master?svg=true)](https://ci.appveyor.com/project/finchik/testing)

#### Deployment: https://finchik.github.io/testing/
